...
class CLIP(nn.Module):
    ...
    @staticmethod
    def get_config(clip_path='/share/home/lyq/.cache/clip/ViT-B-32.pt'):
    ...
    def encode_text(self, text, return_hidden=False):
        ...
        x = hidden[torch.arange(hidden.shape[0]), text.argmax(dim=-1)]  # x : batch * d_model, hidden : [batch_size, n_ctx, d_model]
